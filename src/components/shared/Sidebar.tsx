...
interface NavItem {
  ...
  /** Only super_admin / gerente see this item. */
  adminOnly?: boolean;
  children?: NavChild[];
}
...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    module: "workers",
    children: [
      { label: "Equipo", href: "/workers", icon: Users },
      { label: "Postulaciones", href: "/workers/applications", icon: Briefcase },
      { label: "Vacantes activas", href: "/workers/positions", icon: Briefcase },
    ],
  },
  {
    label: "Contabilidad",
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Empresa", href: "/settings/general", icon: Settings },
    ],
  },
];
...
export function Sidebar() {
  ...
  const visibleItems = NAV_ITEMS.filter((item) =>
    item.adminOnly ? isAdmin : canViewModule(item.module),
  );
      ...
      <div className="flex h-16 items-center justify-between px-3 shrink-0">
          ...
          {expanded && (
            ...
            >
              {isLogoImage(logoValue) ? (
                ...
                <span className="h-6 w-6 flex items-center justify-center text-lg leading-none shrink-0">
                  {logoValue}
                </span>
              ) : (
        ...
        {!expanded &&
          (isLogoImage(logoValue) ? (
            ...
            <span className="h-6 w-6 flex items-center justify-center text-lg leading-none mx-auto">
              {logoValue}
            </span>
          ) : (
            <Coffee className="h-6 w-6 text-primary mx-auto" />
          ))}
                      ...
                      <div className="ml-4 mt-1 space-y-1 border-l border-sidebar-border pl-3">
                        {item.children
                          ...
                          <NavLink
                            ...
                            className={({ isActive }) =>
                              cn(
                                "flex items-center gap-2 rounded-md px-3 py-1.5 text-xs transition-colors cursor-pointer",
                                "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
                                isActive
                                  ? "bg-sidebar-accent text-sidebar-accent-foreground font-medium"
                                  : "text-sidebar-foreground",

  ...
  if (openKey !== lastOpenKey) {
    ...
    if (open) {
      if (worker) {
        ...
        // Limpia el estado de "recién creado" de una creación anterior: sin
        // esto, editar tras crear deja los campos deshabilitados y sin botón
        // de guardar (el modal cree que sigue en el flujo de creación).
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid grid-cols-2 h-auto! w-full sm:flex sm:h-8! sm:w-full">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-2 col-span-2">
                  ...
                  <Input
                    id="email"
                    type="email"
                    placeholder="juan.perez@aromaticocafe.com"
          ...
          <TabsContent value="permissions" className="mt-4">
            {activeWorker && (
              <>
                ...
                />
                <div className="flex flex-col gap-2 mt-4 pt-4 border-t sm:flex-row">
                  <Button
                    type="button"
                    variant="outline"
                    className="flex-1"
